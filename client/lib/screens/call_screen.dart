...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> _init() async {
    ...
    // То же самое, что и с remoteStream ниже: своё видео могло быть
    // включено ЗАДОЛГО до того, как появился именно этот экземпляр
    // CallScreen (свернули в PiP и развернули обратно — новый экран,
    // новый пустой _localRenderer) — без явного подхвата текущего
    // состояния тут своя мини-превьюшка так и оставалась бы пустой до
    // следующего ручного вкл/выкл видео кнопкой (единственное место,
    // которое раньше вызывало _syncLocalRenderer).
    _syncLocalRenderer();
